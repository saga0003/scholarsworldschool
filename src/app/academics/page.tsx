            ...
            <div className="grid gap-8 lg:grid-cols-2">
              {PROGRAMS.map((p, i) => (
                <Reveal key={p.id} delay={0.06 * i}>
                  <Link
                    href={p.href}
                    className="group grid h-full overflow-hidden rounded-[2rem] border border-navy/8 bg-cream shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-gold hover:shadow-[0_24px_50px_rgba(0,19,41,0.14)] sm:grid-cols-2"
                  ...
                  >
                    <div className="relative h-64 overflow-hidden sm:h-full sm:min-h-[300px]">
                      ...
                      />
                      <span className="absolute left-4 top-4 rounded-full bg-navy/90 px-3 py-1 text-[11px] font-extrabold uppercase tracking-wider text-gold backdrop-blur-sm">
                        {p.kicker}
                      </span>
                    </div>
                    <div className="flex flex-col justify-center p-7">
                      ...
                      <span className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-navy">
                        Explore the program
                        <ArrowRight className="h-4 w-4 text-gold-deep transition-transform duration-300 group-hover:translate-x-1.5" />
                      </span>
                    </div>
                  </Link>
                </Reveal>
